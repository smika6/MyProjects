...
public class Menu extends MouseAdapter{
    ...
    public Menu(Game game){
        this.game=game;
        game.getHandler().getObjects().clear();
    }
    ...
    public void render(Graphics g){
        if(game.getState() == STATE.Menu){
            ...
            g.setFont(fnt);
            g.drawString("SmikaAstroids",600,240);
            g.setFont(fnt2);
            g.drawString("By Jacob Hopkins 2/4/2019", 600, 280);
            ...
            Font fnt2 = new Font("arial", 1, 30);
            g.setFont(fnt2);
            g.drawString("Alpha version of astroid defense game",300,400);
