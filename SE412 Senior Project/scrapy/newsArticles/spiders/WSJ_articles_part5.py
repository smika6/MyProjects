	...
	def after_login(self, response):
		...
		if(response.status == 200):
			...
			json = {
				...
				"urls": [
					"https://www.wsj.com/articles/donald-trumps-inauguration-brings-in-over-30-million-viewers-1485039516",
					"https://www.wsj.com/articles/judge-brett-kavanaugh-in-his-own-words-1531187704",
					"https://www.wsj.com/articles/whats-really-going-on-at-area-51-maybe-the-biggest-ufo-party-on-earth-11567783089"
				]
			}
