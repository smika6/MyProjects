	...
	def after_login(self, response):
		...
		if(response.status == 200):
			...
			json = {
				...
				"urls": [
					"https://www.wsj.com/articles/george-floyd-arrest-death-in-minneapolis-police-custody-spark-more-protests-11590599760",
					"https://www.wsj.com/articles/riot-at-the-u-s-capitol-11610068066"
				]
			}
